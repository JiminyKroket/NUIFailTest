...
//console.log(isDrawing, lastPoint, 'id, lp');
var isDrawing, lastPoint;
var canvas = document.getElementById('canvas');
var ctx = canvas.getContext('2d');
//console.log(canvas, ctx, 'can, ctx');
var canvasWidth = canvas.width;
var canvasHeight= canvas.height;
//console.log(canvasWidth, canvasHeight, 'cw, ch');
var image = new Image();
var imageSrc = 'img/scratch-here.jpg';
var brush = new Image();
image.src = imageSrc;
//console.log(image, imageSrc, brush, image.src);
